...
public class Main : MonoBehaviour
{
    ...
    public int grassSum = 0;
    public int healthRabbit = 0;
    public Text myText;
    public Text myText2;
    ...
    public KeyCode showMenuKey2 = KeyCode.Tab;

    void Start()
    {
        exit.onClick.AddListener(Exit);
        exit2.onClick.AddListener(Exit);
    ...
    void Update()
    {
        ...
        {
            changeparam.SetActive(true);
            help.SetActive(false);
        }

        grassSum = grassSum + Rabbit5.GetComponent<AI_rabbit>().sumGrass;
        healthRabbit = Rabbit5.GetComponent<AI_rabbit>().Health;
        ...
        myText.text = "Популяция кроликов = " + Rabbit5.GetComponent<AI_rabbit>().counter2;
